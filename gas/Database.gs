...
function initializeDatabase() {
  ...
  if (servicesSheet.getLastRow() <= 1) {
    var defaultServices = [
      // Мужские
      { id: "svc_m1", name: "Стрижка классическая", genderCategory: "male", categoryId: "type_1", categoryName: "Стрижка", price: 800, duration: "00:45", description: "Классическая мужская стрижка ножницами", status: "active", createdAt: new Date().toISOString() },
      { id: "svc_m2", name: "Стрижка машинкой", genderCategory: "male", categoryId: "type_1", categoryName: "Стрижка", price: 500, duration: "00:30", description: "Стрижка под машинку", status: "active", createdAt: new Date().toISOString() },
      { id: "svc_m3", name: "Оформление бороды", genderCategory: "male", categoryId: "type_1", categoryName: "Стрижка", price: 600, duration: "00:30", description: "Стрижка и окантовка бороды", status: "active", createdAt: new Date().toISOString() },
      { id: "svc_m4", name: "Мужской маникюр", genderCategory: "male", categoryId: "type_2", categoryName: "Маникюр", price: 700, duration: "00:45", description: "Гигиенический маникюр для мужчин", status: "active", createdAt: new Date().toISOString() },
      { id: "svc_m5", name: "Мужской педикюр", genderCategory: "male", categoryId: "type_3", categoryName: "Педикюр", price: 1200, duration: "01:00", description: "Гигиенический педикюр", status: "active", createdAt: new Date().toISOString() },
      { id: "svc_m6", name: "Камуфляж седины", genderCategory: "male", categoryId: "type_4", categoryName: "Окрашивание", price: 1500, duration: "00:45", description: "Естественное закрашивание седины", status: "active", createdAt: new Date().toISOString() },
      // Женские
      { id: "svc_f1", name: "Стрижка модельная", genderCategory: "female", categoryId: "type_1", categoryName: "Стрижка", price: 1200, duration: "01:00", description: "Модельная женская стрижка", status: "active", createdAt: new Date().toISOString() },
      { id: "svc_f2", name: "Стрижка челки", genderCategory: "female", categoryId: "type_1", categoryName: "Стрижка", price: 300, duration: "00:15", description: "Коррекция челки", status: "active", createdAt: new Date().toISOString() },
      { id: "svc_f3", name: "Маникюр + Гель-лак", genderCategory: "female", categoryId: "type_2", categoryName: "Маникюр", price: 1000, duration: "01:30", description: "Аппаратный/комбинированный маникюр с покрытием", status: "active", createdAt: new Date().toISOString() },
      { id: "svc_f4", name: "Наращивание ногтей", genderCategory: "female", categoryId: "type_2", categoryName: "Маникюр", price: 1800, duration: "02:30", description: "Наращивание полигелем/гелем", status: "active", createdAt: new Date().toISOString() },
      { id: "svc_f5", name: "Педикюр эстетический", genderCategory: "female", categoryId: "type_3", categoryName: "Педикюр", price: 1500, duration: "01:30", description: "Обработка стоп и покрытие гель-лаком", status: "active", createdAt: new Date().toISOString() },
      { id: "svc_f6", name: "Сложное окрашивание", genderCategory: "female", categoryId: "type_4", categoryName: "Окрашивание", price: 5000, duration: "03:00", description: "Airtouch, шатуш, балаяж", status: "active", createdAt: new Date().toISOString() },
      { id: "svc_f7", name: "Окрашивание в один тон", genderCategory: "female", categoryId: "type_4", categoryName: "Окрашивание", price: 2500, duration: "01:30", description: "Тонирование/окрашивание по всей длине", status: "active", createdAt: new Date().toISOString() },
      { id: "svc_f8", name: "Вечерняя укладка", genderCategory: "female", categoryId: "type_5", categoryName: "Укладка", price: 1500, duration: "01:00", description: "Локоны, сложные прически", status: "active", createdAt: new Date().toISOString() },
      { id: "svc_f9", name: "Ламинирование бровей", genderCategory: "female", categoryId: "type_6", categoryName: "Брови и ресницы", price: 1200, duration: "01:00", description: "Долговременная укладка бровей + окрашивание", status: "active", createdAt: new Date().toISOString() },
      { id: "svc_f10", name: "Наращивание ресниц 2D", genderCategory: "female", categoryId: "type_6", categoryName: "Брови и ресницы", price: 1800, duration: "02:00", description: "Объемное наращивание", status: "active", createdAt: new Date().toISOString() },
      // Любые (Unisex)
      { id: "svc_u1", name: "Массаж спины", genderCategory: "any", categoryId: "type_7", categoryName: "Массаж", price: 1500, duration: "00:45", description: "Лечебный массаж спины и шейно-воротниковой зоны", status: "active", createdAt: new Date().toISOString() },
      { id: "svc_u2", name: "Антистресс массаж", genderCategory: "any", categoryId: "type_7", categoryName: "Массаж", price: 2500, duration: "01:30", description: "Общий расслабляющий массаж тела", status: "active", createdAt: new Date().toISOString() },
      { id: "svc_u3", name: "Чистка лица комбинированная", genderCategory: "any", categoryId: "type_8", categoryName: "Уход за лицом", price: 2000, duration: "01:30", description: "Ультразвуковая + механическая чистка", status: "active", createdAt: new Date().toISOString() },
      { id: "svc_u4", name: "Пилинг", genderCategory: "any", categoryId: "type_8", categoryName: "Уход за лицом", price: 1500, duration: "00:45", description: "Химический пилинг лица", status: "active", createdAt: new Date().toISOString() }
    ];
